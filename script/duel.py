    ...
    while True:
        ...
        for i in players:
            while len(players[i].hand) < 4:
                players[i].drawACard()
                drawing.drawingAll(myMouse,DISPLAYSURF, player, npc, None, None, None)
        for i in players:
            turnStarts()
            ...
            if mainPhase.mainPhase(DISPLAYSURF, player, npc) == "BattlePhase":
                ...
                drawing.drawingAll(myMouse,DISPLAYSURF, player, npc, "EndPhase", None, None)
...
# def oldDuelStart(DISPLAYSURF, player, npc, myMouse):
#     # global TURNSCOUNTER
#     print("Time to duel!")
#     nameDuelFont = pygame.font.Font(None,100)
